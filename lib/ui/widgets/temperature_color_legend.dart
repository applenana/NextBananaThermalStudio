...
class _HorizontalLegend extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Text('${_formatTemperature(tMin)}°', style: _legendValueStyle),
        ...
        const SizedBox(width: 5),
        Text('${_formatTemperature(tMax)}°', style: _legendValueStyle),
...
class _GradientBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: horizontal ? double.infinity : 11,
      height: horizontal ? 9 : double.infinity,
      child: DecoratedBox(
        decoration: BoxDecoration(
